    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Prepare the Avocados:Halve and pit the avocados.</li>
          <li>
            Mix the Ingredients:Add the chopped onion, tomato, jalapeños,
            cilantro, and lime juice to the mashed avocados.
          </li>
          <li>Season and Serve:Add salt to taste and stir well.</li>
        </ol>
